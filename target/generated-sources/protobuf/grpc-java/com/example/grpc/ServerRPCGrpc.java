...
public final class ServerRPCGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.Server.RequestServer,
      com.example.grpc.Server.ResponseServer> getCommitMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.grpc.Server.RequestServer,
      com.example.grpc.Server.ResponseServer> getCommitMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.Server.RequestServer, com.example.grpc.Server.ResponseServer> getCommitMethod;
    if ((getCommitMethod = ServerRPCGrpc.getCommitMethod) == null) {
      synchronized (ServerRPCGrpc.class) {
        if ((getCommitMethod = ServerRPCGrpc.getCommitMethod) == null) {
          ServerRPCGrpc.getCommitMethod = getCommitMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.Server.RequestServer, com.example.grpc.Server.ResponseServer>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.Server.ResponseServer.getDefaultInstance()))
              .setSchemaDescriptor(new ServerRPCMethodDescriptorSupplier("commit"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.Server.RequestServer,
      com.example.grpc.Server.ResponseServer> getAbortMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.grpc.Server.RequestServer,
      com.example.grpc.Server.ResponseServer> getAbortMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.Server.RequestServer, com.example.grpc.Server.ResponseServer> getAbortMethod;
    if ((getAbortMethod = ServerRPCGrpc.getAbortMethod) == null) {
      synchronized (ServerRPCGrpc.class) {
        if ((getAbortMethod = ServerRPCGrpc.getAbortMethod) == null) {
          ServerRPCGrpc.getAbortMethod = getAbortMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.Server.RequestServer, com.example.grpc.Server.ResponseServer>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.Server.ResponseServer.getDefaultInstance()))
              .setSchemaDescriptor(new ServerRPCMethodDescriptorSupplier("abort"))
              .build();
        }
      }
    }
  ...
  public static abstract class ServerRPCImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void commit(com.example.grpc.Server.RequestServer request,
        io.grpc.stub.StreamObserver<com.example.grpc.Server.ResponseServer> responseObserver) {
    ...
    /**
     */
    public void abort(com.example.grpc.Server.RequestServer request,
        io.grpc.stub.StreamObserver<com.example.grpc.Server.ResponseServer> responseObserver) {
  ...
  public static final class ServerRPCBlockingStub extends io.grpc.stub.AbstractBlockingStub<ServerRPCBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.Server.ResponseServer commit(com.example.grpc.Server.RequestServer request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public com.example.grpc.Server.ResponseServer abort(com.example.grpc.Server.RequestServer request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ServerRPCFutureStub extends io.grpc.stub.AbstractFutureStub<ServerRPCFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.Server.ResponseServer> commit(
        com.example.grpc.Server.RequestServer request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.Server.ResponseServer> abort(
        com.example.grpc.Server.RequestServer request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final int METHODID_ABORT = 4;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_COMMIT:
          serviceImpl.commit((com.example.grpc.Server.RequestServer) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.Server.ResponseServer>) responseObserver);
          break;
        case METHODID_ABORT:
          serviceImpl.abort((com.example.grpc.Server.RequestServer) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.Server.ResponseServer>) responseObserver);
          break;
        default:
